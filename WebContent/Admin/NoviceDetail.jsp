	...
	%>
        ...
        <div id="page-wrapper">
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Novice Details</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
							...
							try 
							 ...
							 {}
							String novice_id=" ",fname=" ",lname=" ",fullname=" ",email=" ",contact=" ",join_date=" ",city_name=" ",status=" ",user_type=" ";
							int country_id=0;
							int state_id=0;
							Connection con;
							String sql;
								...
								try 
								 {
									...
									sql="select *from courseatwheel.user where user_type='novice'";
