							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<a class="active" href='TrainerExam.jsp?cid=<%=course_id%>&tid=<%=topic_id%>&lid=<%=lecture_id%>'><button type="button" class="btn btn-danger btn-lg">Exam</button></a>
									</div>
								</div><!-- /# card -->
							</div>
						</div> <!-- .buttons -->
