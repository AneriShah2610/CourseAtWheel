                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a class="active" href='TrainerAssignment.jsp?cid=<%=course_id%>&tid=<%=topic_id%>&lid=<%=lecture_id%>'><button type="button" class="btn btn-danger btn-lg">Assignment</button></a>
