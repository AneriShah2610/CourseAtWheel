...
<html>
	<head>
		<title>DeActivatedCourse</title>
	</head>
	<body>
		<%
		int course_category_id=0,course_id=0,course_novice_id=0;
		String user_id=" ",course_name=" ",course_image=" ",trainer_id=" ",description=" ",status=" ";
							...
							try
							 {
								 ...
								 sql="SELECT * FROM courseatwheel.course_novice where novice_id='"+user_id+"' and status='DeActivated'";
											...
											<form action="caw11" method="post" role="form" class="form-horizontal" name="courseForm">
												<table class="table table-striped b-t b-light">
													...
													<div>
														...
														<tr>
															<td> <input type="submit" name="submit" id="submit" value="ReAdd">
														</tr>
