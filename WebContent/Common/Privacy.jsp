	...
	<body>
		<header class="text-center" name="home">
		  <div class="intro-text">
			<a href="Index.jsp"> Back to Room </a>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<h3> Purpose </h3>
					<p>
						The purpose of this Privacy Policy is to describe how CourseAtWheel, Inc. ("CourseAtWheel," "us," "we," or "our") collects, uses and shares information about you through our U.S. online interfaces (e.g., websites and mobile applications) owned and controlled by us, including www.CourseAtWheel.org (collectively referred to herein as the "Site"). Please read this notice carefully to understand what we do. If you do not understand any aspects of our Privacy Policy, please feel free to contact us at anerishah36@gmail.com . Your use of our Site is also governed by our <a href="Terms.jsp">Terms of Use </a>.
					</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<h3> What Information this Privacy Policy Covers </h3>
					<p>
						This Privacy Policy covers information we collect from you through our Site. Some of our Site’s functionality can be used without revealing any personal information, though for features or services related to the Online Courses, personal information is required. If you do not use these specific features or services on the Site, then the only information we collect will be "Non-Personal Information" (i.e., information that cannot be used to identify you). Non-Personal Information includes information such as the web pages that you have viewed. In order to access certain features and benefits on our Site, you may need to submit "Personally Identifiable Information" (i.e., information that can be used to identify you). Personally Identifiable Information can include information such as your name and email address, among other things. You are responsible for ensuring the accuracy of the Personally Identifiable Information you submit to CourseAtWheel. Inaccurate information may affect your ability to use the Site, the information you receive when using the Site, and our ability to contact you. For example, your email address should be kept current because that is one of the primary manners in which we communicate with you.
					</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<h3> What You Consent to by Using Our Site </h3>
					<p>
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<p>
						...
						Personally Identifiable Information. We collect Personally Identifiable Information that you provide to us when you register for an account, update or change information for your account, purchase products or services, complete a survey, sign-up for email updates or Online Courses, participate in our public forums, send us email messages, and/or participate in Online Courses or other services on our Site. We may use the Personally Identifiable Information that you provide to respond to your questions, provide you the specific course and/or services you select, send you updates about Online Courses offered by CourseAtWheel or other CourseAtWheel events, and send you email messages about Site maintenance or updates.
						...
						Partner sites providing Online Course related tools and services to CourseAtWheel users may collect nonfinancial individual level user data regarding the individual’s use of that partner site while engaged with such Online Course related activities, and the partner sites may share that data with CourseAtWheel for the purpose of improving CourseAtWheel’s services, the partner site’s services, and the individual’s education experience. This data includes information such as the amount of time spent on the partner site and pages viewed.

						Third Party Credit Card Processing. CourseAtWheel provides you with the ability to pay for Online Courses and other services using a credit card through a third party payment processing service provider. Please note that our service provider – not CourseAtWheel – collects and processes your credit card information.
					</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					...
					<p>
						...
						Personally Identifiable Information. Except as set forth in this Privacy Policy or as specifically agreed to by you, CourseAtWheel will not disclose any Personally Identifiable Information we gather from you on the Site. In addition to the other uses set forth in this Privacy Policy, we may disclose and otherwise use Personally Identifiable Information as described below. We may also use it for research and business purposes, including improving and customizing the Site and the products and services we offer.
						...
						Identity Verification. For services that require identity verification (e.g., the Signature Track or ACE-CREDIT courses), we use the Personally Identifiable Information that we collect for verifying your identity, and for authenticating that submissions made on the Site were made by you. Your photo identification document will be deleted after successful verification of your profile information.

						Communications with CourseAtWheel. When you send us an email message or otherwise contact us, we may use the information provided by you to respond to your communication and/or as described in this Privacy Policy. We may also archive this information and/or use it for future communications with you.

						Communications with CourseAtWheel Business Partners. We may share your Personally Identifiable Information with University partners and other business partners of CourseAtWheel so that CourseAtWheel University partners and other business partners may share information about their products and services that may be of interest to you.
						...
						Disclosure to CourseAtWheel Operations and Maintenance Contractors. We use various service providers, vendors and contractors (collectively, "Contractors") to assist us in providing our products and services to you. Our Contractors may have limited access to your Personally Identifiable Information in the course of providing their products or services to us, so that we in turn can provide our products and services to you. These Contractors may include vendors and suppliers that provide us with technology, services, and/or content related to the operation and maintenance of the Site or the Online Course. Access to your Personally Identifiable Information by these contractors is limited to the information reasonably necessary for the contractor to perform its limited function for us.

						Government Authorities, Legal Rights and Actions. CourseAtWheel may share your Personally Identifiable Information with various government authorities in response to subpoenas, court orders, or other legal process; to establish or exercise our legal rights or to protect our property; to defend against legal claims; or as otherwise required by law. In such cases we reserve the right to raise or waive any legal objection or right available to us. We also may share your Personally Identifiable Information when we believe it is appropriate to investigate, prevent, or take action regarding illegal or suspected illegal activities; to protect and defend the rights, property, or safety of CourseAtWheel, the Site, our users, customers, or others; and in connection with our Terms of Use and other agreements.

						Disclosure to Acquirers. CourseAtWheel may disclose and/or transfer your Personally Identifiable Information to an acquirer, assignee or other successor entity in connection with a sale, merger, or reorganization of all or substantially all of the equity, business or assets of CourseAtWheel to which your Personally Identifiable Information relates.

						e-Readers. If we receive any Personally Identifiable Information related to the extent to which you use designated e-Readers to access CourseAtWheel materials, we may archive it, and use it for research, business, or other purposes.
					</p>
				</div>
			</div>
		</div>
